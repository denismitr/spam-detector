...
use Denismitr\Spam\Inspections\EnglishForbiddenWords;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

class EnglishForbiddenWordsSpec extends ObjectBehavior
{
    protected $forbidden;

    public function let()
    {
        $this->forbidden = (new EnglishForbiddenWords)->getForbiddenWords();
    }

    function it_is_initializable()
    {
        $this->shouldHaveType(EnglishForbiddenWords::class);
    ...
    function it_detects_any_forbidden_word()
    {
        foreach ($this->forbidden as $word) {
            $this
                ...
                ->duringDetect("Всякий текст " . $word . " ещё текст");
        }
    }
    ...
    function it_should_not_throw_on_normal_text()
    {
        $this
            ...
            ->duringDetect("Всякий текст разный, и даже ещё текст");
    }
}
